  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="bg-white rounded-2xl shadow-[0px_2px_12px_rgba(232,116,42,0.10)] border border-orange-100 p-6">
        <h3 className="font-bold text-brown-900 mb-4">소개</h3>
      ...
      <div className="bg-white rounded-2xl shadow-[0px_2px_12px_rgba(232,116,42,0.10)] border border-orange-100 p-6">
        <h3 className="font-bold text-brown-900 mb-4">경력</h3>
        <p className="text-stone-500 text-sm leading-relaxed whitespace-pre-line">
      ...
      <div className="bg-white rounded-2xl shadow-[0px_2px_12px_rgba(232,116,42,0.10)] border border-orange-100 p-6">
        <h3 className="font-bold text-brown-900 mb-4">사진</h3>
        {sitter.activity_photo_urls.length === 0 ? (
          <p className="text-stone-400 text-sm">등록된 사진이 없습니다.</p>
        ) : (
